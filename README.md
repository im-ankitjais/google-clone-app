...
#### This Project is a clone of Google Search Engine.It gives search results using Google API.
...
### Want to Use This Project, Go through these Steps:

### Clone this Repo and Navigate to this root directory.

#### `git clone https://github.com/im-ankitjais/google-clone-app.git`
#### `cd google-clone-app.git`
